    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-6">
              ...
              <a href="https://discord.gg/d2QWzygGjA" target="_blank" rel="noopener noreferrer" className="px-4 py-2 text-gray-700 text-sm font-medium hover:bg-gray-100 rounded-md transition-colors">
                Support
              </a>
            </nav>
          </div>
      ...
      <article className="max-w-4xl mx-auto px-4 py-12">
        ...
        <section className="mb-12 bg-gray-50 p-8 rounded-lg">
          <h2 className="text-3xl font-bold mb-4 text-gray-900">How Does a Cronus Zen Script Work?</h2>
          <div className="space-y-4">
            <div>
              <h3 className="text-xl font-semibold mb-2 text-gray-900">1. Hardware Connection</h3>
              <p className="text-gray-700">
                The Cronus Zen device connects between your controller and gaming system (PS5, PS4, Xbox, or PC). It intercepts all controller inputs before they reach your console.
              </p>
            </div>
            <div>
            ...
            <div>
              <h3 className="text-xl font-semibold mb-2 text-gray-900">4. Seamless Gameplay</h3>
              <p className="text-gray-700">
                To your console or PC, these modified inputs look like normal controller commands, making the enhancements completely undetectable.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12 bg-blue-50 p-8 rounded-lg border border-blue-200">
          ...
          <ul className="space-y-2 text-lg text-gray-700">
            <li className="flex items-start gap-2">
              ...
              <span><strong>PlayStation 5</strong> - Full compatibility with DualSense controllers</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-green-600 mt-1">✓</span>
              <span><strong>PlayStation 4</strong> - Works with DualShock 4 controllers</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-green-600 mt-1">✓</span>
              <span><strong>Xbox Series X/S</strong> - Compatible with Xbox Wireless Controllers</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-green-600 mt-1">✓</span>
              <span><strong>Xbox One</strong> - Full support for Xbox One controllers</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-green-600 mt-1">✓</span>
              <span><strong>PC (Steam)</strong> - Works with any controller through the Cronus Zen</span>
            </li>
          </ul>
        </section>
          ...
          <div className="bg-green-50 border border-green-200 p-6 rounded-lg mb-4">
            ...
            <ul className="space-y-2 text-gray-700">
              <li className="flex items-start gap-2">
                ...
                <span>Hardware-level operation - no software modifications to the game</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-600">•</span>
                <span>Inputs appear as legitimate controller commands</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-600">•</span>
                <span>No injection or modification of game files</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-600">•</span>
                <span>Used by thousands of players without bans</span>
              </li>
            </ul>
          </div>
          <p className="text-lg text-gray-700">
            The Cronus Zen operates transparently to anti-cheat systems because it doesn't modify the game itself - it only modifies your controller inputs, which is indistinguishable from a highly skilled player.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-lg text-gray-700">
                First, you'll need to purchase a Cronus Zen device. This is the hardware that runs the scripts. You can find it at most gaming retailers or online stores.
              </p>
            </div>
            <div>
        ...
        <section className="bg-primary text-white p-8 rounded-lg text-center mb-12">
          ...
          <p className="text-sm mt-4 opacity-90">
            ✓ Instant Access  ✓ Lifetime Updates  ✓ 24/7 Discord Support
          </p>
        </section>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                <li><a href="https://discord.gg/d2QWzygGjA" target="_blank" rel="noopener noreferrer" className="hover:text-white">Discord Community</a></li>
                <li><a href="https://discord.gg/d2QWzygGjA" target="_blank" rel="noopener noreferrer" className="hover:text-white">Installation Guide</a></li>
                <li><a href="https://discord.gg/d2QWzygGjA" target="_blank" rel="noopener noreferrer" className="hover:text-white">Contact Us</a></li>
              </ul>
            </div>
            <div>
